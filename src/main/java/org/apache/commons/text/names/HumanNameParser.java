...
//        String EXAMPLE_TEST = "mr Hamdi T. Al mr tahery mr";
//        String pattern = "(?i)mr.?|"mr.?;
//        String updated = EXAMPLE_TEST.replaceAll(pattern, "gggg"); 
//        System.out.println(updated);
//        System.out.println(suffixes);        
//        System.out.println(suffixRegex);
//        System.out.println(prefixes);        
//        System.out.println(lastRegex);
        ...
        if (StringUtils.isBlank(first)) {
            System.out.println("Couldn't find a first name in '{" + nameString.getWrappedString() + "}'");
        ...
        return new Name(name, leadingInit, first, nickname, middle, last, suffix);
    }
