...
public class ImageTransparency {
    ...
    public static BufferedImage makeImageTranslucent(Image img , double alpha) {
        return makeImageTranslucent(toBufferedImage(img), alpha) ;
    }
