package com.ksu.mailnoti.fortest.contrastenhancement;
...
//        }
        ...
        String inputFileName = "C:\\images for test\\test (1).jpg";
        String outputFileName = "C:\\images for test\\testcont.jpg";
        double delta= 2.0;
